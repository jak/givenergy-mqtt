    ...
    meters: [
      {
        ...
        hardwareVersion: 1,
        softwareVersion: 1,
        voltage: [242.5, 0, 0] as [number, number, number],
        current: [10.3, 0, 0] as [number, number, number],
        activePower: [2500, 0, 0] as [number, number, number],
        activePowerTotal: 2500,
        reactivePower: [100, 0, 0] as [number, number, number],
        reactivePowerTotal: 100,
        apparentPower: [2502, 0, 0] as [number, number, number],
        apparentPowerTotal: 2502,
        powerFactor: [0.99, 0, 0] as [number, number, number],
        powerFactorTotal: 0.99,
        frequency: 50.01,
        importActiveEnergyKwh: 3200.1,
        importReactiveEnergy: 100.5,
        exportActiveEnergyKwh: 8500.3,
        exportReactiveEnergy: 50.2,
      },
    ],
    chargeSlots: [{ start: "00:30", end: "04:30" }],
    dischargeSlots: [{ start: "16:00", end: "07:00" }],
    ...overrides,
  } as InverterSnapshot;
}
